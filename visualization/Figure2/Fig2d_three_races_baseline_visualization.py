...
# Define folder path
path = r"D:\Desktop\Fig2d_baseline_data"
...
combined_df = pd.concat(
    [pd.read_csv(f)[['Baseline']] for f in all_files],
    axis=1
)
combined_df.columns = file_names

# ArBaseline columns in the desired order
...
plt.ylim(0.36, 0.51)
plt.yticks([i / 100 for i in range(36, 51, 2)], fontsize=18)
plt.ylabel(r'$B$', fontsize=20)
plt.title('Baseline', fontsize=28, color='#333333')
...
output_path = r"D:\Desktop\Fig2d_baseline.svg"
